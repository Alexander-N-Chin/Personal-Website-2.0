export const skillProjectData = {
  skills: [
    { id: "java", name: "Java", projectIds: ["e5"] },
    {
      id: "python",
      name: "Python",
      projectIds: ["e1", "e2", "e3", "e4", "p2", "p6", "p7", "p8"],
    },
    { id: "mips", name: "MIPS Assembly", projectIds: ["p4"] },
    {
      id: "bash",
      name: "Shell Bash",
      projectIds: ["e1", "e2", "e3", "e4", "p1", "p2", "p3", "p5", "p6", "p7", "p0", "p8"],
    },
    ...
    { id: "git", name: "Git", projectIds: ["e1", "e2", "e3", "e4", "p0", "p1", "p2", "p3", "p4", "p5", "p6", "p7", "p8"] },
    { id: "sql", name: "SQL", projectIds: ["e1", "p2"] },
    { id: "latex", name: "LaTex", projectIds: ["e2", "e3", "p8"] },
    {
      id: "react",
      name: "React.js",
      projectIds: ["p1", "p2", "p3", "p5", "p7"],
    ...
    { id: "jupyter", name: "Jupyter Notebook", projectIds: ["e3", "p6", "p7", "p8"] },
    { id: "pandas", name: "Pandas", projectIds: ["e2", "e3", "p6", "p7", "p0"] },
    { id: "numpy", name: "NumPy", projectIds: ["e2", "e3", "p6", "p7", "p0"] },
    { id: "LV", name: "LabView", projectIds: ["e2"] },
    { id: "klay", name: "KLayout", projectIds: ["e2"] },
    { id: "matplotlib", name: "MatPlotLib", projectIds: ["e2", "e3", "p7", "p0"] },
    { id: "sci", name: "Scikit Learn", projectIds: ["e3", "p6", "p7", "p8"] },
    ...
    { id: "figma", name: "Figma", projectIds: ["e3", "p1", "p2", "p5", "p7", "p8"] },
    ...
    { id: "probe", name: "Probe Station", projectIds: ["e2"] },
    { id: "litho", name: "Photo Lithography", projectIds: ["e2"] },
    { id: "ion", name: "Ion Miller", projectIds: ["e2"] },
    { id: "evap", name: "E-Beam Evaporation", projectIds: ["e2"] },
  ],
  experiences: [
    {
      id: "e1",
  ...
  projects: [
    ...
    {
      id: "p8",
      name: "Physically Secure Logic Locking With Nanomagnet Logic",
      skillIds: ["python", "latex", "sci", "figma", "jupyter", "git", "bash"],
      description: "This research explores the potential of nanomagnet logic (NML) for secure logic locking, demonstrating its effectiveness against physical attacks and enhancing the security of integrated circuits. The findings highlight the promise of NML in developing robust encryption schemes for future computing systems. I significantly contributed to the writing of the academic paper 'Physically Secure Logic Locking With Nanomagnet Logic' and discovered an effective encryption scheme for the new encrypted islands scheme against an enhanced physical decryption attack Sat solver. I gave a presentation on this work at Magnetism and Magnetic Materials(MMM) 2024 Conference and published in IEEE Transactions on Computer-Aided Design of Integrated Circuits and Systems.",
      images: ["/images/fig1.gif", "/images/fig2.gif"],
      date: "2024",
      links: ["https://ieeexplore.ieee.org/abstract/document/10611730"],
